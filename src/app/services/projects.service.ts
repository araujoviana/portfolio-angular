...
export class ProjectsService {
  ...
  projects = [{
    ...
    },
    {
      ...
      description: "A lightweight web application designed for JSON validation, built using Svelte, TypeScript, and Vite. Employs Bulma CSS for styling and is optimized for GitHub Pages deployment. Provides a user-friendly interface for checking JSON syntax and structure. Intended as a proof-of-concept, showcasing modern web development practices.",
      ...
      description: "A command-line Tic-Tac-Toe game implemented in Haskell. Integrates a Minimax algorithm, enabling the bot to make optimal decisions. Draws inspiration from Cledersonbc's Python version. Uses Cabal, the Haskell build tool, for building and execution.",
      ...
      description: "A Haskell-based command-line tool designed to organize BMP images based on color intensity. Analyzes pixel data within a specified folder, calculating the intensity of a chosen color channel (red, green, or blue). Sorts images in ascending or descending order and renames them accordingly.",
      ...
      name: "Project Assembly Estrutura Dados",
      ...
      id: "notas-latex-2024",
      name: "Notas Latex 2024",
      brief: "Personal notes in LaTeX with a website",
      description: "A repository containing personal lecture notes in LaTeX format from 2024, with PDF versions available. Includes scripts designed to expedite file maintenance and general repository upkeep.",
      ...
      brief: "Odin project assignment - Tic-Tac-Toe",
      ...
      brief: "Odin project assignment - Admin Dashboard",
      ...
      brief: "Odin Project Assignment - Sign-up Form",
      ...
      brief: "Odin Project Assignment - Calculator",
      ...
      brief: "Odin Project Assignment - Etch-a-Sketch",
